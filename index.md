...
I am an **Assistant Teaching Professor** 👩🏻‍🏫 in the [Department of Cognitive Science](https://cogsci.ucsd.edu/){:target="_blank"}  at **UC San Diego** ☀️ where I [teach](https://lucylai.com/teaching.html){:target="_blank"} a variety of courses in the [Machine Learning & Neural Computation Specialization](https://cogsci.ucsd.edu/undergraduates/major/machine-learning.html){:target="_blank"} of the Cognitive Science major. I also run a [mini-research group](https://lucylai.com/research.html){:target="_blank"} focused on understanding the algorithms behind human learning and decision making in health and disease. If you are a UCSD student, you can learn more about me and my teaching philosophy [here](https://lucylai.com/ucsd){:target="_blank"}.
...
### recent and upcoming
* **Nov 2026:** Giving a talk at the [Center for Computational Psychiatry](https://icahn.mssm.edu/research/center-for-computational-psychiatry) at the Icahn School of Medicine at Mount Sinai in NYC
* **Aug 2026:** Gave the keynote talk at the [Colors of the Brain](https://colorsofthebrain.com/) MINDS (Mentoring, Inclusion, and Neuroscience Discoveries) Symposium!
...
* **Jul 2025:** Attended [CogSci 2025](https://cognitivesciencesociety.org/cogsci-2025/) in San Francisco, CA 
